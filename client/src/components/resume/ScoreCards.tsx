  ...
  return (
    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl shadow-lg p-6 border border-green-200">
        ...
        <div className={`text-3xl sm:text-4xl font-bold ${getScoreColor(overallScore)}`}>
          {overallScore}%
        </div>
      ...
      <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl shadow-lg p-6 border border-blue-200">
        ...
        <div className={`text-3xl sm:text-4xl font-bold ${getScoreColor(atsCompatibility)}`}>
          {atsCompatibility}%
        </div>
      ...
      <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl shadow-lg p-6 border border-purple-200">
        ...
        <div className={`text-3xl sm:text-4xl font-bold ${getScoreColor(keywordMatch)}`}>
          {keywordMatch}%
        </div>
      ...
      <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl shadow-lg p-6 border border-orange-200">
        ...
        <div className={`text-3xl sm:text-4xl font-bold ${getScoreColor(formatting)}`}>
          {formatting}%
        </div>
